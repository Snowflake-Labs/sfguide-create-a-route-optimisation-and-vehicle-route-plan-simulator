...
- **Use em dashes or en dashes (the wide Unicode dashes) in any text** - write plain ASCII hyphens (-) only. This applies to docs, SKILL.md prose, code comments, string literals, commit messages, and friction/error logs. Never paste the wide Unicode dash characters; use a normal hyphen.
