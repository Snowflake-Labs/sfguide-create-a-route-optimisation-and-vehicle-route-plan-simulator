...
INSERT INTO FLEET_INTELLIGENCE.CORE.REGION_REGISTRY
  (REGION_NAME, DISPLAY_NAME, CENTER_LAT, CENTER_LON, BBOX_MIN_LAT, BBOX_MAX_LAT, BBOX_MIN_LON, BBOX_MAX_LON, ZOOM_LEVEL, ORS_REGION_KEY, DATA_SOURCE, IS_DEFAULT, PROVISIONED_AT)
VALUES
  ('SanFrancisco', 'San Francisco', 37.7749, -122.4194, 37.7, 37.82, -122.52, -122.35, 11, 'SanFrancisco', 'SEED_DATA', TRUE, CURRENT_TIMESTAMP());
