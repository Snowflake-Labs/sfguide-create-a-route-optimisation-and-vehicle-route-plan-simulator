...
def get_service_display_info(service_name):
    ...
    service_map = {
        ...
        'OPENROUTESERVICE_NATIVE_APP': {'icon': '🗺️', 'display': 'Open Route Service', 'desc': 'Core routing and directions service'},
...
if not service_status_df.empty:
    ...
    st.warning("⚠️ No services found. Make sure you have the required permissions to view services in the OPENROUTESERVICE_NATIVE_APP.CORE schema.")
    st.info("""
    **Required Permissions:**
    - USAGE on OPENROUTESERVICE_NATIVE_APP database
    - USAGE on OPENROUTESERVICE_NATIVE_APP.CORE schema
