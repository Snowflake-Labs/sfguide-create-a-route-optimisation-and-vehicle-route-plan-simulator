...
|-----------|------|-------------|
| `LOCATIONS_DESCRIPTION` | VARCHAR | Natural language locations (e.g., "from Times Square to Central Park via Empire State Building") |
...
| `cycling-mountain` | Mountain bicycle |
| `cycling-road` | Road bicycle |
| `cycling-electric` | Electric bicycle |
| `foot-walking` | Pedestrian walking |
| `foot-hiking` | Hiking trails |
| `wheelchair` | Wheelchair accessible routes |

> **_NOTE:_** Available profiles depend on your OpenRouteService configuration. 
