...
snow spcs image-registry login -c ppaczewskisnowhouse

REPO_URL=$(snow spcs image-repository url openrouteservice_setup.public.image_repository -c ppaczewskisnowhouse)
