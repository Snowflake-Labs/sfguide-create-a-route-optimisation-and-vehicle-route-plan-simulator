...
1. Create stage:
   ```sql
   CREATE STAGE IF NOT EXISTS FLEET_INTELLIGENCE.ROUTE_OPTIMIZATION.STREAMLIT 
...
2. Upload files:
   ...
   snow stage copy "assets/streamlit/routing.py" \
     @FLEET_INTELLIGENCE.ROUTE_OPTIMIZATION.STREAMLIT --connection <ACTIVE_CONNECTION> --overwrite
...
3. Create the Streamlit app:
   ```sql
   CREATE OR REPLACE STREAMLIT FLEET_INTELLIGENCE.ROUTE_OPTIMIZATION.SIMULATOR
   FROM  @FLEET_INTELLIGENCE.ROUTE_OPTIMIZATION.STREAMLIT
