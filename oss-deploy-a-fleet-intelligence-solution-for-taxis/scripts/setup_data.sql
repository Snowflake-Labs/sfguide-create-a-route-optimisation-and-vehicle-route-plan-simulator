...
-------------------------------------------------------------
-- FLEET_INTELLIGENCE DATABASE AND SCHEMA SETUP
-------------------------------------------------------------
...
-------------------------------------------------------------
-- STEP 10: Create views in PUBLIC schema
-------------------------------------------------------------

USE SCHEMA FLEET_INTELLIGENCE.PUBLIC;

CREATE OR REPLACE VIEW SF_ADDRESSES AS
SELECT * FROM FLEET_INTELLIGENCE.ANALYTICS.SF_ADDRESSES;

CREATE OR REPLACE VIEW DRIVERS AS
SELECT * FROM FLEET_INTELLIGENCE.ANALYTICS.DRIVERS;

CREATE OR REPLACE VIEW DRIVER_LOCATIONS AS
SELECT * FROM FLEET_INTELLIGENCE.ANALYTICS.DRIVER_LOCATIONS;

CREATE OR REPLACE VIEW DRIVER_ACTIVITY_HOURLY AS
SELECT * FROM FLEET_INTELLIGENCE.ANALYTICS.DRIVER_ACTIVITY_HOURLY;

-------------------------------------------------------------
-- VERIFICATION: Check data was created
-------------------------------------------------------------

SELECT 'SF_ADDRESSES' AS TABLE_NAME, COUNT(*) AS ROW_COUNT FROM FLEET_INTELLIGENCE.ANALYTICS.SF_ADDRESSES
UNION ALL SELECT 'DRIVERS', COUNT(*) FROM FLEET_INTELLIGENCE.ANALYTICS.DRIVERS
UNION ALL SELECT 'TRIPS', COUNT(*) FROM FLEET_INTELLIGENCE.ANALYTICS.TRIPS
UNION ALL SELECT 'ROUTE_NAMES', COUNT(*) FROM FLEET_INTELLIGENCE.ANALYTICS.ROUTE_NAMES
UNION ALL SELECT 'TRIPS_ASSIGNED_TO_DRIVERS', COUNT(*) FROM FLEET_INTELLIGENCE.ANALYTICS.TRIPS_ASSIGNED_TO_DRIVERS
UNION ALL SELECT 'DRIVER_LOCATIONS', COUNT(*) FROM FLEET_INTELLIGENCE.ANALYTICS.DRIVER_LOCATIONS
UNION ALL SELECT 'TRIP_ROUTE_PLAN', COUNT(*) FROM FLEET_INTELLIGENCE.ANALYTICS.TRIP_ROUTE_PLAN
UNION ALL SELECT 'TRIP_SUMMARY', COUNT(*) FROM FLEET_INTELLIGENCE.ANALYTICS.TRIP_SUMMARY
UNION ALL SELECT 'DRIVER_ACTIVITY_HOURLY', COUNT(*) FROM FLEET_INTELLIGENCE.ANALYTICS.DRIVER_ACTIVITY_HOURLY;
...
FROM FLEET_INTELLIGENCE.ANALYTICS.DRIVERS
GROUP BY SHIFT_TYPE
ORDER BY MIN(SHIFT_START_HOUR);

-- Show hourly driver coverage (peak hours should have more drivers)
SELECT * FROM FLEET_INTELLIGENCE.ANALYTICS.DRIVER_ACTIVITY_HOURLY ORDER BY HOUR_OF_DAY;
