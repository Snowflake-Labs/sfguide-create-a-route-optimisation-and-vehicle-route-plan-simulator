...
These views allow the skill to read from the unified Data Studio tables (`SYNTHETIC_DATASETS.UNIFIED`), filtered to e-bike courier data only.
...
SELECT
    TRIP_ID AS ORDER_ID,
    VEHICLE_ID AS COURIER_ID,
    ORIGIN_POI_ID AS RESTAURANT_ID,
    DESTINATION_POI_ID AS CUSTOMER_ADDRESS_ID,
    ORIGIN_LAT AS RESTAURANT_LAT,
    ORIGIN_LON AS RESTAURANT_LON,
    DESTINATION_LAT AS CUSTOMER_LAT,
    DESTINATION_LON AS CUSTOMER_LON,
    ROUTE_GEOG AS GEOMETRY,
    DISTANCE_KM,
    DURATION_MINUTES,
    TRIP_START AS PICKUP_TIME,
    TRIP_END AS DELIVERY_TIME,
