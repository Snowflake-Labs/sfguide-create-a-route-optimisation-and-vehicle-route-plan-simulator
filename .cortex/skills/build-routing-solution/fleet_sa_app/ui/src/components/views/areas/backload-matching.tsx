...
const TRAILERS_SQL =
  ...
  "MAX_PAYLOAD_KG AS max_payload_kg, STATUS AS status FROM FLEET_INTELLIGENCE.BACKLOAD_MATCHING.VW_TRAILERS " +
...
const OFFERS_SQL =
  ...
  "WEIGHT_KG AS weight_kg, PRICE_EUR AS price_eur FROM FLEET_INTELLIGENCE.BACKLOAD_MATCHING.VW_EXTERNAL_OFFERS " +
