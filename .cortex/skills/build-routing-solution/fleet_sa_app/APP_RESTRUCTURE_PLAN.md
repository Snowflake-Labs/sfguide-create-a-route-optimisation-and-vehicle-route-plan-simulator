...
> - R5-R8: NOT done — large multi-session efforts (control-app rewrite onto Next+kit; migrate 12 demo pages to consumer packs; blue/green cutover; distribution). See Section 5; each warrants a dedicated session.
