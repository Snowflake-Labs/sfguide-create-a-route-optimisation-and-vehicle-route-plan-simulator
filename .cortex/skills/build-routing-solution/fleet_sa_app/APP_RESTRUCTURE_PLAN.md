...
> - R5-R8: R5 DONE — see below. R6/R7/R8 NOT done.
...
> - R6-R8: NOT done — large multi-session efforts (migrate 12 demo pages to consumer packs; blue/green cutover retiring the Vite app; distribution). See Section 5.
