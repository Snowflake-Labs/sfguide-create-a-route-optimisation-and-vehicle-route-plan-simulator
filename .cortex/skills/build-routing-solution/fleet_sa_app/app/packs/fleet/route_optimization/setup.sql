...
CREATE OR REPLACE VIEW FLEET_APP.ROUTE_OPTIMIZATION.VW_IDLE_TRAILERS AS
...
CREATE OR REPLACE VIEW FLEET_APP.ROUTE_OPTIMIZATION.VW_FLEET_HGV_PROFILE AS
WITH filtered AS (
...
LEFT JOIN FLEET_APP.ROUTE_OPTIMIZATION.VW_FLEET_HGV_PROFILE hgv ON hgv.VEHICLE_ID = t.VEHICLE_ID
