...
| query_taxis | `FLEET_INTELLIGENCE.SEMANTIC.SV_TAXIS` | `FLEET_INTELLIGENCE_TAXIS` |
| query_food_delivery | `FLEET_INTELLIGENCE.SEMANTIC.SV_FOOD_DELIVERY` | `FLEET_INTELLIGENCE_FOOD_DELIVERY` |
| query_retail_catchment | `FLEET_INTELLIGENCE.SEMANTIC.SV_RETAIL_CATCHMENT` | `RETAIL_CATCHMENT` |
| query_freight_marketplace | `FLEET_INTELLIGENCE.SEMANTIC.SV_FREIGHT_MARKETPLACE` | `MARKETPLACE` |
