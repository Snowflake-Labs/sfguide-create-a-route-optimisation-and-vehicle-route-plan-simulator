...
//
// This is the reusable map DSL Solution Accelerator lacks: it extracts the
// per-page deck.gl layer-building logic (FleetMap, CongestionMap, etc.) into a
// single column-driven compiler. The same module ports unchanged into the SA
// Map area in Step 2.
...
function pathData(spec: PathLayerSpec, rows: Row[]): { path: number[][] }[] {
