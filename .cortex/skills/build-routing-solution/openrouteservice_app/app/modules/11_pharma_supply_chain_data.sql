...
-- ============================================================
-- PLANT_BUILDING_FOOTPRINTS (from Overture Maps Buildings)
-- CTAS with per-plant UNION ALL subqueries. Each subquery uses a
-- literal ST_MAKEPOINT so the spatial index on BUILDING.GEOMETRY
-- is utilised. A VIEW with JOIN doesn't push the predicate down.
