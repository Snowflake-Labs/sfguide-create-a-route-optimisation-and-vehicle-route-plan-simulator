...
export default function DriverPerformance() {
  ...
  useEffect(() => {
    setLoading(true);
    sfQuery(`SELECT DRIVER_ID, TOTAL_TRIPS, TOTAL_DWELLS, AVG_DWELL_MINUTES, SLA_BREACHES, ROUND(SLA_BREACHES*100.0/NULLIF(TOTAL_DWELLS,0),1) AS BREACH_RATE, TOTAL_DWELL_MINUTES FROM DT_DRIVER_DWELL_SUMMARY ORDER BY TOTAL_TRIPS DESC LIMIT 30`)
      .then(setData)
