...
export default function FleetMap() {
  ...
  return (
    <div>
      ...
      <p style={{ color: 'var(--text-secondary)', fontSize: 13, marginBottom: 16 }}>Courier positions and delivery routes</p>

      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 12, marginBottom: 16 }}>
        {[
          { label: 'Couriers', value: kpis.COURIERS ?? '—' },
          { label: 'Deliveries', value: kpis.DELIVERIES ?? '—' },
          { label: 'Avg Delivery', value: `${kpis.AVG_DELIVERY_MIN ?? '—'} min` },
        ].map(m => (
      ...
      <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
        ...
        <div style={{ flex: '0 0 260px', maxHeight: 560, overflowY: 'auto' }}>
          <h3 style={{ fontSize: 14, color: 'var(--text-secondary)', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 }}>Couriers</h3>
