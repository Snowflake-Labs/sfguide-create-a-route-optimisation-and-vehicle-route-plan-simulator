...
-- view (VW_FLEET_VEHICLE_PROFILE) is provided that COALESCEs against deterministic
...
-- to the underlying table. Without this, the next control-app boot
...
CREATE OR REPLACE VIEW FLEET_INTELLIGENCE.ROUTE_OPTIMIZATION.VW_FLEET_VEHICLE_PROFILE
...
FROM FLEET_INTELLIGENCE.ROUTE_OPTIMIZATION.VW_FLEET_VEHICLE_PROFILE
