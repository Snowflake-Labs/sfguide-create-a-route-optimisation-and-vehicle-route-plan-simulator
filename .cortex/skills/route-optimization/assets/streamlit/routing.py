...
# Industry lookup
lookup_table = session.table('ROUTE_OPTIMIZATION.LOOKUP')
...
places_filtered = session.table('ROUTE_OPTIMIZATION.PLACES')
...
time_slots = session.table('ROUTE_OPTIMIZATION.JOB_TEMPLATE')
