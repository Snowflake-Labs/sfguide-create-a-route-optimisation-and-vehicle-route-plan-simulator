...
--------------------------------------------------------------------
CREATE OR REPLACE VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_EBIKE.DELIVERIES AS
SELECT
...
ALTER VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_EBIKE.DELIVERIES SET COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-ebike","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';

--------------------------------------------------------------------
-- RESTAURANTS_ENRICHED (CatchmentPanel.tsx)
--------------------------------------------------------------------
CREATE OR REPLACE VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_EBIKE.RESTAURANTS_ENRICHED AS
SELECT
...
ALTER VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_EBIKE.RESTAURANTS_ENRICHED SET COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-ebike","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
