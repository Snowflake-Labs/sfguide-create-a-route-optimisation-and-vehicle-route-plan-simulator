...
SELECT
  ...
  ST_MAKEPOINT(ROUND(AVG(LONGITUDE), 6), ROUND(AVG(LATITUDE), 6)) AS AVG_POINT,
  H3_POINT_TO_CELL_STRING(ST_MAKEPOINT(AVG(LONGITUDE), AVG(LATITUDE)), 7) AS H3_CELL_R7
FROM sessions
...
SELECT
  ...
  s.PING_COUNT, s.AVG_LAT, s.AVG_LNG, s.AVG_POINT, s.H3_CELL_R7,
...
SELECT
  ...
  e.PING_COUNT, e.AVG_LAT, e.AVG_LNG, e.AVG_POINT, e.H3_CELL_R7,
