...
- `.cortex/skills/install-fleet-apps/fleet_admin_app/ui/src/server/lib/init.ts` - runs on every container boot.
...
| SOURCE | VARCHAR(30) | FACT_FREIGHT_OFFERS | DISPATCH / MARKETPLACE / PARTNER_APP / INTERNAL |
