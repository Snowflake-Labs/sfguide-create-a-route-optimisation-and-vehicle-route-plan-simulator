...
FROM FLEET_INTELLIGENCE.ROUTE_DEVIATION.VW_TRUCK_TELEMETRY
...
### VW_TRUCK_TELEMETRY (local projection view)
| Column | Type | Used By |
|--------|------|---------|
...
DROP VIEW IF EXISTS FLEET_INTELLIGENCE.ROUTE_DEVIATION.VW_TRUCK_TELEMETRY;
