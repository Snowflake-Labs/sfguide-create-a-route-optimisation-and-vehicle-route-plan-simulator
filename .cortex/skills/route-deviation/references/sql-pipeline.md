...
FROM (
    SELECT
        ...
        $1:LAT::DOUBLE,
        $1:LNG::DOUBLE,
        $1:HAS_EV_CHARGING::BOOLEAN,
        $1:AREA_M2::DOUBLE,
        $1:CAPACITY_RATING::VARCHAR
...
FROM (
    SELECT
        $1:TRUCK_ID::VARCHAR,
        $1:HOME_BASE_ID::VARCHAR,
        $1:HOME_BASE_NAME::VARCHAR,
        $1:HOME_LNG::DOUBLE,
        $1:HOME_LAT::DOUBLE,
        ...
        $1:BASE_SPEED_KMH::DOUBLE,
        $1:SHIFT_TYPE::VARCHAR
...
FROM (
    SELECT
        ...
        $1:LOCATION_TYPE::VARCHAR,
        $1:CREATED_AT::VARCHAR::TIMESTAMP_NTZ,
