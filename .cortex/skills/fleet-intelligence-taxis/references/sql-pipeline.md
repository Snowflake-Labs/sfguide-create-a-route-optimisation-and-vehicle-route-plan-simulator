...
```sql
PUT 'file://assets/streamlit/Taxi_Control_Center.py' @OPENROUTESERVICE_SETUP.FLEET_INTELLIGENCE_TAXIS.STREAMLIT_STAGE/taxi/ AUTO_COMPRESS=FALSE OVERWRITE=TRUE;
PUT 'file://assets/streamlit/extra.css' @OPENROUTESERVICE_SETUP.FLEET_INTELLIGENCE_TAXIS.STREAMLIT_STAGE/taxi/ AUTO_COMPRESS=FALSE OVERWRITE=TRUE;
PUT 'file://assets/streamlit/logo.svg' @OPENROUTESERVICE_SETUP.FLEET_INTELLIGENCE_TAXIS.STREAMLIT_STAGE/taxi/ AUTO_COMPRESS=FALSE OVERWRITE=TRUE;
PUT 'file://assets/streamlit/environment.yml' @OPENROUTESERVICE_SETUP.FLEET_INTELLIGENCE_TAXIS.STREAMLIT_STAGE/taxi/ AUTO_COMPRESS=FALSE OVERWRITE=TRUE;
PUT 'file://assets/streamlit/city_config.py' @OPENROUTESERVICE_SETUP.FLEET_INTELLIGENCE_TAXIS.STREAMLIT_STAGE/taxi/ AUTO_COMPRESS=FALSE OVERWRITE=TRUE;
PUT 'file://assets/streamlit/pages/1_Driver_Routes.py' @OPENROUTESERVICE_SETUP.FLEET_INTELLIGENCE_TAXIS.STREAMLIT_STAGE/taxi/pages/ AUTO_COMPRESS=FALSE OVERWRITE=TRUE;
PUT 'file://assets/streamlit/pages/2_Heat_Map.py' @OPENROUTESERVICE_SETUP.FLEET_INTELLIGENCE_TAXIS.STREAMLIT_STAGE/taxi/pages/ AUTO_COMPRESS=FALSE OVERWRITE=TRUE;
```
