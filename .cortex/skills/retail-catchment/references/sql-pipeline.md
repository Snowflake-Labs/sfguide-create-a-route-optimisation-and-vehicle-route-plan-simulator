...
CREATE TABLE IF NOT EXISTS FLEET_INTELLIGENCE.CATCHMENT.CONFIG (
    ...
    COMMENT = '{"origin":"sf_sit-is-fleet", "name":"oss-retail-catchment", "version":{"major":1, "minor":0}, "attributes":{"is_quickstart":1, "source":"sql"}}';
MERGE INTO FLEET_INTELLIGENCE.CATCHMENT.CONFIG tgt
...
DELETE FROM FLEET_INTELLIGENCE.CATCHMENT.POIS WHERE REGION = $REGION_KEY;
...
```sql
ALTER TABLE FLEET_INTELLIGENCE.CATCHMENT.POIS SET COMMENT = '{"origin":"sf_sit-is-fleet", "name":"oss-retail-catchment", "version":{"major":1, "minor":0}, "attributes":{"is_quickstart":1, "source":"sql"}}';
```
...
DELETE FROM FLEET_INTELLIGENCE.CATCHMENT.CITIES_BY_STATE WHERE REGION = $REGION_KEY;
...
```sql
ALTER TABLE FLEET_INTELLIGENCE.CATCHMENT.CITIES_BY_STATE SET COMMENT = '{"origin":"sf_sit-is-fleet", "name":"oss-retail-catchment", "version":{"major":1, "minor":0}, "attributes":{"is_quickstart":1, "source":"sql"}}';
```
...
DELETE FROM FLEET_INTELLIGENCE.CATCHMENT.REGIONAL_ADDRESSES WHERE REGION = $REGION_KEY;
...
```sql
ALTER TABLE FLEET_INTELLIGENCE.CATCHMENT.REGIONAL_ADDRESSES SET COMMENT = '{"origin":"sf_sit-is-fleet", "name":"oss-retail-catchment", "version":{"major":1, "minor":0}, "attributes":{"is_quickstart":1, "source":"sql"}}';
```

**5e. Store region configuration:**

```sql
CREATE TABLE IF NOT EXISTS FLEET_INTELLIGENCE.CATCHMENT.REGION_CONFIG (
    REGION        VARCHAR NOT NULL,
    REGION_NAME   VARCHAR,
    BBOX_MIN_LON  FLOAT,
    BBOX_MIN_LAT  FLOAT,
...
DELETE FROM FLEET_INTELLIGENCE.CATCHMENT.REGION_CONFIG WHERE REGION = $REGION_KEY;
INSERT INTO FLEET_INTELLIGENCE.CATCHMENT.REGION_CONFIG
SELECT 
    $REGION_KEY AS REGION,
...
```sql
ALTER TABLE FLEET_INTELLIGENCE.CATCHMENT.REGION_CONFIG SET COMMENT = '{"origin":"sf_sit-is-fleet", "name":"oss-retail-catchment", "version":{"major":1, "minor":0}, "attributes":{"is_quickstart":1, "source":"sql"}}';
```

**5f. Add search optimization:**

```sql
ALTER TABLE FLEET_INTELLIGENCE.CATCHMENT.POIS ADD SEARCH OPTIMIZATION ON EQUALITY(STATE, CITY, BASIC_CATEGORY);
ALTER TABLE FLEET_INTELLIGENCE.CATCHMENT.REGIONAL_ADDRESSES ADD SEARCH OPTIMIZATION ON GEO(GEOMETRY);
ALTER TABLE FLEET_INTELLIGENCE.CATCHMENT.CITIES_BY_STATE ADD SEARCH OPTIMIZATION ON EQUALITY(STATE);
```

**5g. Add clustering:**

```sql
ALTER TABLE FLEET_INTELLIGENCE.CATCHMENT.POIS CLUSTER BY (STATE, CITY, BASIC_CATEGORY);
ALTER TABLE FLEET_INTELLIGENCE.CATCHMENT.REGIONAL_ADDRESSES CLUSTER BY (LONGITUDE, LATITUDE);
```

**5h. Verify tables:**

```sql
SELECT 'POIS' AS TABLE_NAME, COUNT(*) AS ROW_COUNT FROM FLEET_INTELLIGENCE.CATCHMENT.POIS
UNION ALL
SELECT 'CITIES_BY_STATE', COUNT(*) FROM FLEET_INTELLIGENCE.CATCHMENT.CITIES_BY_STATE
UNION ALL
SELECT 'REGIONAL_ADDRESSES', COUNT(*) FROM FLEET_INTELLIGENCE.CATCHMENT.REGIONAL_ADDRESSES;
```
