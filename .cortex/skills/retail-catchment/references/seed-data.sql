...
-- The CREATE statement runs AFTER the FLEET_INTELLIGENCE.CATCHMENT schema below,
...
CREATE OR REPLACE TEMP TABLE FLEET_INTELLIGENCE.CATCHMENT._RC_REGION_BOUNDARY AS
...
LEFT JOIN FLEET_INTELLIGENCE.CATCHMENT._RC_REGION_BOUNDARY b ON TRUE  -- single-row table; NULL boundary => refine skipped
...
-- VALIDATION
--------------------------------------------------------------------
SELECT 'CONFIG' AS TABLE_NAME, COUNT(*) AS ROW_COUNT FROM FLEET_INTELLIGENCE.CATCHMENT.CONFIG
UNION ALL
SELECT 'POIS', COUNT(*) FROM FLEET_INTELLIGENCE.CATCHMENT.POIS
UNION ALL
...
UNION ALL
SELECT 'REGION_CONFIG', COUNT(*) FROM FLEET_INTELLIGENCE.CATCHMENT.REGION_CONFIG;
