...
```sql
COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-install-fleet-apps","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"<sql|app|notebook>"}}'
```
...
and let `routing-solution-cleanup` discover every object this skill created.
