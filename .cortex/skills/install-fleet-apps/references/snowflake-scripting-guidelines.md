...
### Current image tags
> Source of truth: [`openrouteservice_app/image-versions.env`](../openrouteservice_app/image-versions.env). Run `scripts/check_image_versions.sh` after editing this table.

| Service | Image | Tag |
|---------|-------|-----|
| ORS | openrouteservice | v9.10.0 |
| Downloader | downloader | v0.0.11 |
| Gateway | routing_reverse_proxy | v1.1.13 |
| VROOM | vroom-docker | v1.0.4 |
| SA App | fleet_sa_app | v0.1.116 |
| Admin App | fleet_admin_app | v0.1.50 |
