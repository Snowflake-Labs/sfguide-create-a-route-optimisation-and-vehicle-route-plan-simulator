...
| Freight Matching | EXCLUDED from the install-fleet-apps agnostic installer (industry-vertical: marketplace / backload). Re-add only for a freight-specific deployment. | n/a |
