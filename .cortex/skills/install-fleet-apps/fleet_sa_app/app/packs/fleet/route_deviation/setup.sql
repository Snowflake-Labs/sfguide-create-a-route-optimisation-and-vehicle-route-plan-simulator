...
SELECT
  ...
  ROUND(SUM(DISTANCE_DEVIATION_KM), 2) AS TOTAL_EXCESS_KM,
  ROUND(SUM(DURATION_DEVIATION_MIN), 2) AS TOTAL_TIME_LOST_MIN,
  ...
  ROUND(MAX(DISTANCE_DEVIATION_PCT), 2) AS MAX_DISTANCE_DEVIATION_PCT,
  ROUND(MAX(DURATION_DEVIATION_PCT), 2) AS MAX_DURATION_DEVIATION_PCT
