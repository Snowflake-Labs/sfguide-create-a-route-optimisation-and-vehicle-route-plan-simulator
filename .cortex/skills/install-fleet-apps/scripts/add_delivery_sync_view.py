...
VIEW = {
    ...
    "useCase": {
        ...
        "method": (
            ...
            "on site whenever its last known position falls inside a monitored site's "
            "geofence, so the dot and the label can never disagree. The tooltip then "
    ...
    "agentKnowledge": {
        ...
        "gotchas": (
            ...
            "position the map plots (inside the site's geofence), NOT the unload "
