...
} from '@/components/fleet-data-studio/helpers';
import type { EditConfig } from '@/components/fleet-data-studio/types';
import { useStudioCatalog } from '@/components/fleet-data-studio/hooks/useStudioCatalog';
import { useStudioJobs } from '@/components/fleet-data-studio/hooks/useStudioJobs';
import { useStudioStream } from '@/components/fleet-data-studio/hooks/useStudioStream';
import { useJobDetail } from '@/components/fleet-data-studio/hooks/useJobDetail';

import ProfilePickerPanel from '@/components/fleet-data-studio/panels/ProfilePickerPanel';
import ConfigEditorPanel from '@/components/fleet-data-studio/panels/ConfigEditorPanel';
import GenerationDashboardPanel from '@/components/fleet-data-studio/panels/GenerationDashboardPanel';
import JobHistoryTable from '@/components/fleet-data-studio/panels/JobHistoryTable';
import JobDetailDrawer from '@/components/fleet-data-studio/panels/JobDetailDrawer';
import DatasetsPanel from '@/components/fleet-data-studio/panels/DatasetsPanel';

export function FleetDataStudioPage() {
