...
const CONFIG_SCHEMAS = [
  ...
  'FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR', 'FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_EBIKE',
  'FLEET_INTELLIGENCE.CATCHMENT', 'FLEET_INTELLIGENCE.ROUTE_OPTIMIZATION',
