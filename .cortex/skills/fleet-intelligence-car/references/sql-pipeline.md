...
Parse the service spec to find `<REGION_NAME>` from the volume source path: `@OPENROUTESERVICE_APP.CORE.ORS_SPCS_STAGE/<REGION_NAME>`.
...
```sql
SHOW SERVICES IN DATABASE OPENROUTESERVICE_APP.CORE;
```
...
```sql
CALL SYSTEM$GET_SERVICE_LOGS('OPENROUTESERVICE_APP.CORE.ORS_SERVICE', 0, 'ors', 50);
```
...
```sql
CREATE SCHEMA IF NOT EXISTS FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR
    COMMENT = '{"origin":"sf_sit-is-fleet", "name":"oss-fleet-intelligence-car", "version":{"major":1, "minor":0}, "attributes":{"is_quickstart":1, "source":"sql"}}';
```

```sql
CREATE STAGE IF NOT EXISTS FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.STREAMLIT_STAGE
...
## Step 4: Create Base Locations (VEHICLE_LOCATIONS)
...
```sql
CREATE OR REPLACE TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VEHICLE_LOCATIONS AS
...
```sql
ALTER TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VEHICLE_LOCATIONS SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VEHICLE_LOCATIONS
GROUP BY SOURCE_TYPE;
```

---

## Step 5: Create Drivers with Shift Patterns (VEHICLE_DRIVERS)
...
```sql
CREATE OR REPLACE TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VEHICLE_DRIVERS AS
...
```sql
ALTER TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VEHICLE_DRIVERS SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VEHICLE_DRIVERS
GROUP BY SHIFT_TYPE
...
### 6a - Materialize Location Pool (VEHICLE_LOCATIONS_NUMBERED)

```sql
CREATE OR REPLACE TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VEHICLE_LOCATIONS_NUMBERED AS
SELECT 
    LOCATION_ID,
    POINT_GEOM,
    NAME,
...
```sql
ALTER TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VEHICLE_LOCATIONS_NUMBERED SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
```sql
CREATE OR REPLACE TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_TRIPS AS
WITH 
driver_trip_counts AS (
    SELECT 
        ...
        END AS NUM_TRIPS
    FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VEHICLE_DRIVERS d
),
trip_sequence AS (
    SELECT 
        d.DRIVER_ID,
...
loc_count AS (
    SELECT COUNT(*) AS cnt FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VEHICLE_LOCATIONS_NUMBERED
)
SELECT 
...
```sql
ALTER TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_TRIPS SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
```sql
CREATE OR REPLACE TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_TRIPS_WITH_COORDS AS
SELECT 
    t.TRIP_ID,
    t.DRIVER_ID,
    t.TRIP_HOUR,
...
FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_TRIPS t
JOIN FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VEHICLE_LOCATIONS_NUMBERED p ON t.PICKUP_LOC_ID = p.rn
JOIN FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VEHICLE_LOCATIONS_NUMBERED d ON t.DROPOFF_LOC_ID = d.rn;
```

```sql
ALTER TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_TRIPS_WITH_COORDS SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
FROM (
    ...
    FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_TRIPS
...
```sql
CREATE OR REPLACE TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_ROUTES AS
SELECT 
    DRIVER_ID,
    TRIP_ID,
    TRIP_HOUR,
...
FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_TRIPS_WITH_COORDS;
```

```sql
ALTER TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_ROUTES SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
> ```sql
> CREATE OR REPLACE TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_ROUTES_PARSED AS
> SELECT 
...
> FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_TRIPS_WITH_COORDS t,
...
FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_ROUTES
WHERE ROUTE_RESPONSE IS NOT NULL;
```

```sql
ALTER TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_ROUTES_PARSED SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
```sql
CREATE OR REPLACE TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_ROUTE_GEOMETRIES AS
WITH trip_timing AS (
    SELECT 
        *,
        ROW_NUMBER() OVER (PARTITION BY DRIVER_ID ORDER BY TRIP_HOUR, TRIP_NUMBER) AS DRIVER_TRIP_SEQ
    FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_ROUTES_PARSED
...
```sql
ALTER TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_ROUTE_GEOMETRIES SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_ROUTE_GEOMETRIES;
```
...
```sql
CREATE OR REPLACE TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_LOCATIONS AS
WITH 
route_info AS (
    SELECT 
        DRIVER_ID,
...
```sql
ALTER TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_LOCATIONS SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_LOCATIONS;
```
...
```sql
CREATE OR REPLACE VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_LOCATIONS_V AS
SELECT 
    TRIP_ID,
    DRIVER_ID,
    PICKUP_TIME,
...
```sql
ALTER VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_LOCATIONS_V SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
```sql
CREATE OR REPLACE VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TRIPS_ASSIGNED_TO_DRIVERS AS
SELECT 
    DRIVER_ID,
    TRIP_ID,
    GEOMETRY,
...
```sql
ALTER VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TRIPS_ASSIGNED_TO_DRIVERS SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
```sql
CREATE OR REPLACE VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.ROUTE_NAMES AS
SELECT 
    TRIP_ID,
...
```sql
ALTER VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.ROUTE_NAMES SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
```sql
CREATE OR REPLACE VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TRIP_ROUTE_PLAN AS
SELECT 
    rg.TRIP_ID,
    rg.DRIVER_ID,
    rg.ORIGIN_ADDRESS,
...
FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_ROUTE_GEOMETRIES rg;
```

```sql
ALTER VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TRIP_ROUTE_PLAN SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
```sql
CREATE OR REPLACE VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TRIP_SUMMARY AS
WITH trip_stats AS (
    SELECT 
        TRIP_ID,
...
```sql
ALTER VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TRIP_SUMMARY SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
```sql
SELECT 'DRIVER_LOCATIONS_V' AS VIEW_NAME, COUNT(*) AS ROW_COUNT FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_LOCATIONS_V
UNION ALL SELECT 'TRIPS_ASSIGNED_TO_DRIVERS', COUNT(*) FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TRIPS_ASSIGNED_TO_DRIVERS
UNION ALL SELECT 'ROUTE_NAMES', COUNT(*) FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.ROUTE_NAMES
UNION ALL SELECT 'TRIP_ROUTE_PLAN', COUNT(*) FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TRIP_ROUTE_PLAN
UNION ALL SELECT 'TRIP_SUMMARY', COUNT(*) FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TRIP_SUMMARY;
```
...
```sql
CREATE TABLE IF NOT EXISTS FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.CONFIG (
    VEHICLE_TYPE VARCHAR NOT NULL,
    REGION       VARCHAR NOT NULL
);
MERGE INTO FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.CONFIG tgt
...
ALTER TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.CONFIG SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
```sql
CREATE OR REPLACE VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VW_DRIVER_LOCATIONS AS
SELECT
...
WHERE t.VEHICLE_TYPE = (SELECT VEHICLE_TYPE FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.CONFIG LIMIT 1)
  AND t.REGION = (SELECT REGION FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.CONFIG LIMIT 1)
QUALIFY ROW_NUMBER() OVER (PARTITION BY t.TELEMETRY_ID ORDER BY t.TS) = 1;
```

```sql
ALTER VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VW_DRIVER_LOCATIONS SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
```sql
CREATE OR REPLACE VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VW_TRIP_SUMMARY AS
WITH cfg AS (SELECT VEHICLE_TYPE, REGION FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.CONFIG LIMIT 1),
trip_speeds AS (
...
```sql
ALTER VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VW_TRIP_SUMMARY SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
```sql
ALTER VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TRIP_SUMMARY
  RENAME TO FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TRIP_SUMMARY_NATIVE;
ALTER VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_LOCATIONS_V
  RENAME TO FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_LOCATIONS_V_NATIVE;
```

```sql
CREATE OR REPLACE VIEW FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TRIP_SUMMARY AS
SELECT * FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VW_TRIP_SUMMARY;
```
...
FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VW_DRIVER_LOCATIONS;
```
...
FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VW_TRIP_SUMMARY;
```
...
```sql
SELECT 'TRIP_SUMMARY' AS VIEW_NAME, COUNT(*) AS ROW_COUNT FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TRIP_SUMMARY
UNION ALL SELECT 'DRIVER_LOCATIONS_V', COUNT(*) FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.DRIVER_LOCATIONS_V
UNION ALL SELECT 'VW_TRIP_SUMMARY', COUNT(*) FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VW_TRIP_SUMMARY
UNION ALL SELECT 'VW_DRIVER_LOCATIONS', COUNT(*) FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.VW_DRIVER_LOCATIONS
UNION ALL SELECT 'ROUTE_NAMES', COUNT(*) FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.ROUTE_NAMES
UNION ALL SELECT 'TRIP_ROUTE_PLAN', COUNT(*) FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TRIP_ROUTE_PLAN
UNION ALL SELECT 'TRIPS_ASSIGNED_TO_DRIVERS', COUNT(*) FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TRIPS_ASSIGNED_TO_DRIVERS;
```
