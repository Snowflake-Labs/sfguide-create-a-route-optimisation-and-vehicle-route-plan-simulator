...
```sql
CREATE OR REPLACE TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TAXI_LOCATIONS AS
...
```sql
ALTER TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TAXI_LOCATIONS SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TAXI_LOCATIONS
...
```sql
CREATE OR REPLACE TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TAXI_DRIVERS AS
...
```sql
ALTER TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TAXI_DRIVERS SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TAXI_DRIVERS
GROUP BY SHIFT_TYPE
...
```sql
CREATE OR REPLACE TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TAXI_LOCATIONS_NUMBERED AS
SELECT 
    LOCATION_ID,
    POINT_GEOM,
    NAME,
...
```sql
ALTER TABLE FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TAXI_LOCATIONS_NUMBERED SET
    COMMENT = '{"origin":"sf_sit-is-fleet","name":"oss-fleet-intelligence-car","version":{"major":1,"minor":0},"attributes":{"is_quickstart":1,"source":"sql"}}';
```
...
driver_trip_counts AS (
    SELECT 
        ...
        END AS NUM_TRIPS
    FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TAXI_DRIVERS d
),
trip_sequence AS (
    SELECT 
        d.DRIVER_ID,
...
loc_count AS (
    SELECT COUNT(*) AS cnt FROM FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TAXI_LOCATIONS_NUMBERED
)
SELECT 
...
JOIN FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TAXI_LOCATIONS_NUMBERED p ON t.PICKUP_LOC_ID = p.rn
JOIN FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TAXI_LOCATIONS_NUMBERED d ON t.DROPOFF_LOC_ID = d.rn;
```
