...
All vehicle telemetry data lives in a single unified star schema, regardless of vehicle type (cars, e-bikes, trucks). Data is generated by the **Data Studio** page in the ORS Control App.
...
| **E-Bike Fleet** | Fleet Dashboard, Fleet Map, Catchment Panel, Fleet Heatmap (4 pages) | `FLEET_INTELLIGENCE_EBIKE` views |
| **Car Fleet** | Fleet Overview, Driver Routes, Heat Map (3 pages) | `FLEET_INTELLIGENCE_CAR` tables |
