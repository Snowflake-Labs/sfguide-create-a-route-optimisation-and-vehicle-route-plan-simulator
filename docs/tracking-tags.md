...
| `FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TAXI_LOCATIONS` | Table | Schema |
| `FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TAXI_DRIVERS` | Table | Schema |
| `FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_CAR.TAXI_LOCATIONS_NUMBERED` | Table | Schema |
...
| `FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_EBIKE.DELIVERIES` | View | Schema |
| `FLEET_INTELLIGENCE.FLEET_INTELLIGENCE_EBIKE.RESTAURANTS_ENRICHED` | View | Schema |
